...
class GeofencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create geofence" do
    assert_difference('Geofence.count') do
      post geofences_url, params: { geofence: { lat: @geofence.lat, lon: @geofence.lon, name: @geofence.name, radius: @geofence.radius } }
    end
  ...
  test "should update geofence" do
    patch geofence_url(@geofence), params: { geofence: { lat: @geofence.lat, lon: @geofence.lon, name: @geofence.name, radius: @geofence.radius } }
